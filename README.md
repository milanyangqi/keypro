...
7. 自定义平台输入功能
8. 批量删除功能
9. 号码采集功能（支持地区选择、关键词输入、来源选择、自动采集）
10. 采集结果实时显示和导出功能（Excel/CSV）
...
- v1.4：新增WhatsApp号码采集功能，支持地区选择、关键词输入、来源选择、自动采集、实时状态显示和结果导出
- v1.5：修复采集结果显示为0条的问题，优化Docker部署，更新访问端口为3008
